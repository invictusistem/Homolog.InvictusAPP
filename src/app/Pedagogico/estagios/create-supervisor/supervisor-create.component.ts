...
@Component({
    selector: 'createsupervisormodal',
...
export class SupervisorCreateComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SupervisorCreateComponent>,
...
onSubmit(form: FormGroup) {
    ...
    if (form.valid) {
        ...
        this.http.post(`${this.baseUrl}/estagios/supervisor/${this.data['estagio'].id}`, novoColaborador, {
            //this.http.post("http://api.invictustemp.com.thor.hostazul.com.br/api/identity/login", credentials, {
...
openSnackBar() {
    this._snackBar.open('Supervisor salvo com sucesso.', '', {
