...
@Component({
    selector: "estagiosupervisao-app",
    templateUrl: './estagio-supervisao.component.html',
    styleUrls: ['./estagio-supervisao.component.scss'],
    animations: [HighlightTrigger]
    //
})

export class EstagioSupervisaoComponent implements OnInit {
    ...
    public estagio: any;
    public documentoAluno: any[] = new Array<any>();
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<EstagioSupervisaoComponent>,
    ...
    GetSupervisor() {
        let estagioId = this.data['estagio'].id;

        this._http.get(`${this.baseUrl}/estagios/supervisor/${estagioId}`)
            .subscribe(response => {

                this.estagio = Object.assign({}, response['supervisor'])
                this.documentoAluno = Object.assign([], response['docs'])
